# Verification of Data Flow & Connectivity Between Store Microservices and AWS Data Plane

This section helps me **verify end-to-end connectivity** between the lStore microservices running on **Amazon EKS** and their respective **AWS managed services (data plane)** — such as 
1. AWS RDS, 
2. AWS DynamoDB, 
3. AWS ElastiCache,  
